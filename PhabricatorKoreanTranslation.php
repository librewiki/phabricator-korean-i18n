    ...
    protected function getTranslations() {
        return array(
            ...
            'not done.' => array(
                array(
                    array(
                        '%s 님이 하나의 인라인 의견을 완료됨으로 표시했고 하나의 인라인 의견을 완료되지 않음으로 표시했습니다',
                        '%s 님이 하나의 인라인 의견을 완료됨으로 표시했고 %3$s개의 인라인 의견을 완료되지 않음으로 표시했습니다',
                    ),
                    array(
                        '%s 님이 %s 인라인 의견들을 완료됨으로 표시했고 하나의 인라인 코멘트를 완료되지 않음으로 표시했습니다.',
                        '%s 님이 %s 인라인 의견들을 완료됨으로 표시했고 %s개의 인라인 코멘트를 완료되지 않음으로 표시했습니다.',
                    ),
                ),
            ),
            ...
            '%s edited recipient(s) for %s, awarded %s: %s; revoked %s: %s.' => array(
                array(
                    '%s 님이 %s의 recipient를 수정했습니다, %s 수여 : %s; %s 취소 : %s.',
                    '%s 님이 %s의 recipient를 수정했습니다, %s 수여 : %s; %s 취소 : %s.',
                ),
            ),
            '%s edited recipient(s), awarded %s: %s; revoked %s: %s.' => array(
                array(
                    '%s 님이 recipient를 수정했습니다, %s 수여 : %s; %s 취소 : %s.',
                    '%s 님이 recipient를 수정했습니다, %s 수여 : %s; %s 취소 : %s.',
                ),
            ),
